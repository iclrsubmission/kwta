...
def train(config, cuda_id):
    ...
    train_loader = DataLoader(svhn_train, batch_size = config['train_batch_size'], shuffle=True)
    test_loader = DataLoader(svhn_test, batch_size = config['test_batch_size'], shuffle=True)
